...
Public Class ChargeSlipPPA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "usermanagement.ChargeSlipPPA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChargeSlipPPA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChargeSlipPPA = New ChargeSlipPPA()
        rpt.Site = Me.Site
        Return rpt
    End Function
